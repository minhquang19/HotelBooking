                                ...
                                <div class="single-room list-style avson-go-top">
                                    <div class="row align-items-center no-gutters">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="room-desc">
                                                @if(App()->getLocale()=='en')
                                                    <div class="room-cat"><p>{{$item->category->name}}</p>
                                              ...
                                              @else
                                                    <div class="room-cat"><p>{{$item->category->name_vi}}</p></div>
                                                        ...
                                                        <div class="room-price"><p>{{$item->roomPrice->Weekly}}</p>
                                                        </div>
                        ...
                        <div class="sidebar-wrap">
                            <div class="widget fillter-widget">
                                ...
                                <form action="" method="GET">
                                    <div class="input-wrap"><input type="text" placeholder="{{__('arrive')}}" name="checkin" id="arrive-date" /><i class="far fa-calendar-alt"></i></div>
                                    <div class="input-wrap"><input type="text" placeholder="{{__('depart')}}" name="checkout" id="depart-date" /><i class="far fa-calendar-alt"></i></div>
                                    ...
                                    <div class="input-wrap">
                                        <button type="submit" class="btn filled-btn btn-block">{{__('filter')}}<i class="fas fa-long-arrow-alt-right"></i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
